...
export default function HeroSection({ 
  ...
  return (
    <motion.section
      className="py-12 md:py-24 lg:py-32 xl:py-36 px-4"
      variants={containerVariants}
      initial="centered"
      animate={activeSection !== 'none' ? 'raised' : 'centered'}
    >
      <div className="flex items-center justify-center h-30vh px-4">
...
//   const containerVariants = {
//     centered: { y: 0 },
//     raised: { y: -160, transition: { duration: 0.5, ease: "easeInOut" } }
//   };

//   return (
//     <motion.section
//       className="flex items-center justify-center h-[calc(100vh-132px)] px-4"
//       variants={containerVariants}
//       initial="centered"
//       animate={activeSection !== 'none' ? 'raised' : 'centered'}
//     >
